---
title: "Separating disease seasonality from reporting-calendar effects in tuberculosis notification in India, Ni-kshay 2022-2025"
author:
  - name: Arun Mitra
...
> Draft v1 (2026-06-12). Longitudinal ecological analysis of monthly TB notification, January 2022 to 2025, at the district level (747 Local Government Directory districts with an active TB Unit). Reporting follows STROBE. The study was granted ethics exemption by the AIIMS Bibinagar Institutional Ethics Committee (AIIMS/BBN/IEC/Feb/2025/657-exmp).
...
### 2.5 Ethics
The study was granted exemption from review by the Institutional Ethics Committee of the All India Institute of Medical Sciences, Bibinagar (AIIMS/BBN/IEC/Feb/2025/657-exmp), as it used aggregate programmatic data with no individual identifiers.
...
Several steps would sharpen the separation of signal from artefact. The most direct is to add or reconstruct a symptom-onset date in Ni-kshay and compare onset-dated with report-dated seasonality, which on our account should move the peak earlier. Where district-month respiratory-virus surveillance becomes openly available, co-infection could be modelled rather than only acknowledged. The public-versus-private contrast used here transfers to any notification system with a target-driven public sector alongside a less-incentivised private one, and could be applied to other notifiable conditions and settings. Most useful for the programme would be to build the seasonal and working-day adjustment into routine Ni-kshay review and to evaluate prospectively whether it reduces responses to administrative fluctuation.
